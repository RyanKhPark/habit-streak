...
// New Arena types
export interface Arena extends Models.Document {
  created_by: string; // User who created the arena
  title: string;
  description: string;
  frequency: string;
  created_at: string;
...
// New table for tracking user participation in arenas
export interface ArenaParticipant extends Models.Document {
  arena_id: string;
  user_id: string;
  joined_at: string;
  current_streak: number; // Individual current streak for this user
  longest_streak: number; // Individual longest streak for this user
  total_completions: number; // Total completions by this user
  last_completed_at?: string; // When this user last completed the arena
  is_active: boolean; // Whether user is still participating
  reminder_time?: string; // Optional reminder time
  personal_target?: string; // Personal target for this arena
  notes?: string; // Personal notes
}

export interface ArenaCompletion extends Models.Document {
  arena_id: string;
  user_id: string;
  completed_at: string;
  // Flexible value storage
